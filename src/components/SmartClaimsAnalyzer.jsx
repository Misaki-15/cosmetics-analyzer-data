...
const SmartClaimsAnalyzer = () => {
  ...
  const productCategories = [
    { 
      ...
      applicableEfficacies: ['染发', '烫发', '防脱发', '滋养', '修护', '清洁', '保湿', '防晒', '芳香', '舒缓', '护发', '防断发', '去屑', '发色护理', '控油', '去角质', '美容修饰', '其他']
    },
    { 
      value: 'face', 
      label: '面部护理产品', 
      ...
      applicableEfficacies: ['祛斑美白', '防晒', '祛痘', '滋养', '修护', '清洁', '卸妆', '保湿', '美容修饰', '抗皱', '紧致', '舒缓', '控油', '去角质', '芳香', '爽身', '辅助剃须剃毛', '其他']
    { 
      value: 'body', 
      label: '身体护理产品', 
      icon: '🧴',
      color: 'bg-green-100 text-green-800',
      applicableEfficacies: ['防晒', '滋养', '修护', '清洁', '保湿', '美容修饰', '芳香', '除臭', '舒缓', '控油', '去角质', '爽身', '脱毛', '辅助剃须剃毛', '抗皱', '紧致', '祛痘', '祛斑美白', '卸妆', '其他']
    },
    { 
      value: 'oral', 
      label: '口腔护理产品', 
